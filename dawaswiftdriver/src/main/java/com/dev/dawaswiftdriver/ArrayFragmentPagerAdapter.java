...
public abstract class ArrayFragmentPagerAdapter<T> extends ArrayPagerAdapter<T> {
    ...
    public Object instantiateItem(ViewGroup container, int position) {
        ...
        final ArrayPagerAdapter.IdentifiedItem<T> item = getItemWithId(position);
    ...
    public void destroyItem(ViewGroup container, int position, Object object) {
        ...
        String name = makeFragmentName(((ArrayPagerAdapter.IdentifiedItem) object).id);
    ...
    public boolean isViewFromObject(View view, Object object) {
        for (Fragment fragment : fragmentManager.getFragments()) {
            if (fragment != null) {
                ...
                if (v != null && v == view && makeFragmentName(((ArrayPagerAdapter.IdentifiedItem) object).id).equals(fragment.getTag())) {
                    return true;
                }
            }
        }

...
public class KGDirectionsUtils {
    ...
    public String getDirectionsUrl(LatLng origin, LatLng dest,GoogleMap mMsap) {
        ...
        String url = "https://maps.googleapis.com/maps/api/directions/" + output + "?" + parameters+"&key=AIzaSyA0LQ-9b7FawCeuPd5NYHJC18ZHqTailVI";
    ...
    public  void animateMarkerNew(final LatLng startPosition, final LatLng destination, final Marker marker) {
